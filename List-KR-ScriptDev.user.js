        ...
        var Watch = function(MutationList, Observer)
        {
            for(var Mutation of MutationList)
            {
                for (var i in Array.from(Mutation.target.attributes))
                {
                    ...
                    {
                        var DivElements = LKSLib.SearchElementsHasStyles("div", ["border-top-width: 1px", "border-top-style: solid", "box-sizing: border-box", "word-break: break-all", "background-origin: padding-box", "ackground-size: auto"]);
